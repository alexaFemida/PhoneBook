...
namespace PhoneBook.Controllers
{
    ...
    public class AccountController : Controller
    {
       ...
       public UserManager<Contact> UserManager { get; private set; }
       public UserStoreService UserStoreService { get; private set; }
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            if (ModelState.IsValid){
               var user = UserStoreService.GetByNameAndPassword(model.UserName, model.Password);
               if (user != null)
                {
